...
<svelte:head><title>Email OTP – IOB</title></svelte:head>
...
<div class="screen">
  ...
  <div class="header-area">
    ...
    <div class="icon-row">
      <button class="icon-btn" aria-label="Back" onclick={() => goto(`${base}/email`)}>
  ...
  <div class="content">
    ...
    <div class="title-block">
      ...
      <p class="subtitle">Enter OTP sent to your email address</p>
    </div>
